...
export const fallbackCaseStudies: Project[] = [
  ...
  },
  {
    ...
    challenge:
      "The pub needed one system for stock and product catalog, ticket sales for shows on the public home page, and — most importantly — a VIP club: exclusive chef specials and cocktails for members only, prepaid cards, and a customer login to see every load and charge on the card.",
    challengeHe:
      "הפאב היה צריך מערכת אחת לניהול מלאי וקטלוג מוצרים, מכירת כרטיסים להופעות בדף הבית הציבורי, ובעיקר מועדון VIP: מנות שף וקוקטיילים בלעדיים לחברים בלבד, כרטיסים נטענים, וכניסת לקוח לצפייה בכל טעינה וחיוב בכרטיס.",
    solution:
